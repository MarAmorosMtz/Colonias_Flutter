#include "colonias_detector_ffi.h"
...
DetectionResultFFI detect_colonies(const char* image_path) {
    ...
    try {
        ...
        if (!result.redColonies.empty()) {
            ...
            // Convertir imágenes a buffer de bytes (formato RGBA para Flutter)
            ...
            // Repetir para amarillo y azul...
            // (código similar para yellow_image_data y blue_image_data)
        }
